...
(* 0, 'U_i, m1 + m2,  == 'X_{1..n} is equipped with a semi-monoid structure,  *)
(* m1 - m2, m *+ n, ...  all operations being point-wise, ans using the       *)
(*                       (_ <= _)%MM ordering for truncated substraction.     *)
...
(*                       (n.-tuple {mpoly R[n]}) s.t. 'X_i is substituted by  *)
(*                       (tnth lq i).                                         *)
