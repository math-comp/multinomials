...
Proof.
rewrite [in LHS](multinomUE_id m) (big_morph mf mfM mf1); apply/eq_bigr => i _.
...
Proof.
rewrite -!(big_filter r); elim: {P r}(filter P r) => /= [|x r ih].
  by rewrite !big_nil msupp0.
by rewrite !big_cons; apply/(fsubset_trans (msuppD_le _ _))/fsetUS/ih.
Qed.
